...
class ChangeDateFormatWithoutLosingValuesPreorderhdr extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return array("OrderMarginDate", "FinalDate", "BOMDate", "PrintedDate", "CustomerSvcDate", "DraftDate", "DateMaintained", "DateCreated");
    }
}
